...
p1 <- ggtree(tree, layout = "fan", open.angle = 13, ladderize = FALSE, branch.length = "none") + 
  ...
  geom_hilight(node =  1:10, fill = "#5F9EA0", extend = 11) +
  geom_hilight(node = 13:16, fill = "#5F9EA0", extend = 11) +
  geom_hilight(node = 23:34, fill = "#5F9EA0", extend = 11) +
  geom_hilight(node = 41:46, fill = "#5F9EA0", extend = 11) +
  geom_hilight(node = 48:58, fill = "#5F9EA0", extend = 11) +
...
p3 <- gheatmap(p2, otu_group_map, offset = 10, width = 0.22, font.size = 5, 
  ...
  guides(fill = guide_legend(title = "Existence"), override.aes = list(size = 6)) +
